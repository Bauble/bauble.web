...
def upgrade():
    ...
    create_table('family',
                 ...
                 sa.Column('qualifier', sa.Enum('s. lat.', 's. str.'), nullable=True),
                 sa.PrimaryKeyConstraint('id'),
    ...
    create_table('propagation',
                 sa.Column('prop_type', sa.Enum('Other', 'UnrootedCutting', 'Seed'), nullable=False),
    ...
    create_table('source_detail',
                 ...
                 sa.Column('description', sa.Text(), nullable=True),
                 sa.Column('source_type', sa.Enum('Research/FieldStation', 'UniversityDepartment', 'Individual', 'Other', 'Commercial', 'Staff', 'GeneBank', 'BG', 'Expedition', 'Unknown', 'MunicipalDepartment', 'Club'), nullable=True),
                 sa.PrimaryKeyConstraint('id'),
    ...
    create_table('prop_cutting',
                 sa.Column('cutting_type', sa.Enum('Other', 'InterNodal', 'Nodal'), nullable=True),
                 sa.Column('tip', sa.Enum('Intact', 'Removed', 'None'), nullable=True),
                 sa.Column('leaves', sa.Enum('Intact', 'Removed', 'None'), nullable=True),
                 ...
                 sa.Column('length_unit', sa.Enum('mm', 'in', 'cm'), nullable=True),
                 sa.Column('wound', sa.Enum('No', 'Double', 'Single', 'Slice'), nullable=True),
                 sa.Column('flower_buds', sa.Enum('Removed', 'None'), nullable=True),
                 ...
                 sa.Column('bottom_heat_temp', sa.Integer(), autoincrement=False, nullable=True),
                 sa.Column('bottom_heat_unit', sa.Enum('C', 'F'), nullable=True),
    ...
    create_table('taxon',
                 ...
                 sa.Column('sp_qual', sa.Enum('agg.', 's. lat.', 's. str.'), nullable=True),
    ...
    create_table('accession',
                 ...
                 sa.Column('prov_type', sa.Enum('InsufficientData', 'Cultivated', 'Unknown', 'NotWild', 'Wild'), nullable=True),
                 sa.Column('wild_prov_status', sa.Enum('WildNonNative', 'InsufficientData', 'WildNative', 'Unknown', 'CultivatedNative'), nullable=True),
                 ...
                 sa.Column('recvd_type', sa.Enum('DIVI', 'BUDC', 'RHIZ', 'RCUT', 'UNKN', 'BUDD', 'PLNT', 'CLUM', 'CORM', 'SEDL', 'BBIL', 'GRAF', 'BULB', 'TUBE', 'LAYE', 'BRPL', 'SPOR', 'PSBU', 'ROOT', 'SEED', 'VEGS', 'URCU', 'SCIO', 'SPRL', 'SCKR', 'ALAY', 'ROOC', 'BBPL'), nullable=True),
                 sa.Column('id_qual', sa.Enum('aff.', 'cf.', 'incorrect', 'forsan', 'near', '?'), nullable=True),
    ...
    create_table('plant',
                 ...
                 sa.Column('acc_type', sa.Enum('Vegetative', 'Other', 'Plant', 'Seed', 'Tissue'),
                           nullable=True),
    ...
    create_table('plant_status',
                 sa.Column('date', sa.Date(), nullable=True),
                 sa.Column('condition', sa.Enum('Poor', 'Indistinguishable', 'Good', 'UnableToLocate', 'Fair', 'Questionable', 'Dead', 'Excellent'), nullable=True),
                 sa.Column('comment', sa.Text(), nullable=True),
                 sa.Column('checked_by', sa.String(), nullable=True),
                 sa.Column('flowering_status', sa.Enum(dict_keys(['Old', 'Immature', 'Flowering'])), nullable=True),
                 sa.Column('fruiting_status', sa.Enum(dict_keys(['Unripe', 'Ripe'])), nullable=True),
                 ...
                 sa.Column('sex', sa.Enum('Female', 'Both', 'Male'), nullable=True),
                 sa.Column('plant_id', sa.Integer(), nullable=False),
                 sa.ForeignKeyConstraint(['plant_id'], ['plant.id'], ),
                 sa.PrimaryKeyConstraint('id'))
    ...
    create_table('plant_change',
                 ...
                 sa.Column('reason', sa.Enum('DEAD', 'DELE', 'DISC', 'DIST', 'DNGM', 'FOGS', 'DISW', 'TOTM', 'WINK', 'OTHR', 'BA40', 'DISN', 'GIVE', 'LOST', 'SUMK', 'PLOP', 'ASS#', 'ERRO', 'STOL'), nullable=True),
