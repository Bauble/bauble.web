...
app.controller('AccessionEditCtrl', function ($scope, $location, $modal, $stateParams,
                                              locationStack, Alert, Taxon, Accession,
                                              Source, overlay) {
    $scope.model = {
        accession: {
    ...
    $scope.editSource = function(sourceDetail) {
        var modalInstance = $modal.open({
            templateUrl: '/static/partials/source-detail-edit.html',
